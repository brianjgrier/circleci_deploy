...
variable "aws_public_subnet_list" {
  description = "The list of subnet ids that are attahed to an internet gateway"
}
...
variable "aws_private_subnet_list" {
  description = "The list of subnet ids that are attahed to an internet gateway"
}

variable "aws_private_subnet_id" {
  description = "The subnet-id to be used for the nomad instances"
}

variable "aws_public_subnet_cidr" {
  description = "The cidr to be used for the service instance"
}

variable "aws_private_subnet_cidr" {
  description = "The cidr to be used for the nomad instances"
}

variable "aws_nat_eip_list" {
  description = "the list of EIPs for the VPC, one per NAT GW"
} 
